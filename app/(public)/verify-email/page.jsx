      ...
      <div>
        ...
        <div className="relative group">
          ...
          <input
            ...
            type="email"
            readOnly
            className="w-full pl-10 pr-4 py-3 rounded-xl border border-gray-200 bg-gray-50 text-gray-500 cursor-not-allowed shadow-sm"
          />
        </div>
      </div>
      ...
      <div>
        ...
        <div className="relative group">
          ...
          <input
            ...
            placeholder="••••••"
            className={cn(
              "w-full pl-10 pr-4 py-3 rounded-xl border bg-white/60 backdrop-blur-sm focus:outline-none focus:ring-2 focus:ring-[#DDB892] focus:bg-white transition-all shadow-sm tracking-widest font-mono text-lg font-bold text-[#2C1810]",
